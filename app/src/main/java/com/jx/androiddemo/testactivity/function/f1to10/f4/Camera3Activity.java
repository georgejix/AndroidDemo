package com.jx.androiddemo.testactivity.function.f1to10.f4;
...
//camera1方式的一些功能demo
public class Camera3Activity extends BaseMvpActivity<EmptyPresenter> implements EmptyContract.View,
        MediaRecorder.OnInfoListener, Handler.Callback,
    ...
    TextView textview_facing;
    @BindView(R.id.textview_focus)
    TextView textview_focus;
    @BindView(R.id.textview_flash)
    TextView textview_flash;
    @BindView(R.id.textview_scene)
    TextView textview_scene;
    @BindView(R.id.textview_takephoto)
    TextView textview_takephoto;
    @BindView(R.id.textview_takevideo)
    TextView textview_takevideo;
    ...
    protected int getLayout() {
        return R.layout.activity_f4_camera3;
    }
    ...
    private void initListener() {
        ...
        RxView.clicks(textview_takephoto)
                .throttleFirst(Constants.CLICK_TIME, TimeUnit.MILLISECONDS)
                .compose(this.bindToLifecycle())
                .subscribe(o ->
                {
        ...
        RxView.clicks(textview_takevideo)
                .throttleFirst(Constants.CLICK_TIME, TimeUnit.MILLISECONDS)
                .compose(this.bindToLifecycle())
                .subscribe(o ->
                {
        ...
        RxView.clicks(textview_resolution)
                .throttleFirst(Constants.CLICK_TIME, TimeUnit.MILLISECONDS)
                .compose(this.bindToLifecycle())
                .subscribe(o ->
                {
                });
        RxView.clicks(textview_fps)
                .throttleFirst(Constants.CLICK_TIME, TimeUnit.MILLISECONDS)
                .compose(this.bindToLifecycle())
                .subscribe(o ->
                {

package com.jx.androiddemo.testactivity.function.f11to20.f17;
...
import com.jx.androiddemo.testactivity.function.f11to20.f16.SQLiteDbHelper;
...
public class DemoContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.jx.androiddemo";

...
public class PinchImageView extends androidx.appcompat.widget.AppCompatImageView {
   ...
   public void setRotationBy(float rotateValue) {
      Log.d(TAG, "setRotationBy rotateValue =" + rotateValue);
      currentRotation += rotateValue;
      setRotation(currentRotation);
   }

   public void setRotationByRotateValue(float newRotate) {
      Log.d(TAG, "setRotationByRotateValue newRotate =" + newRotate);
      currentRotation = newRotate;
      post(() -> setRotation(currentRotation));
   }
}
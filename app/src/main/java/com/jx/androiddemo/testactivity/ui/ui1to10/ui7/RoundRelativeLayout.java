package com.jx.androiddemo.testactivity.ui.ui1to10.ui7;
...
public class RoundRelativeLayout extends RelativeLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0, size = getChildCount(); i < size; i++) {
            ...
            if (lp instanceof RoundLayoutParams) {
                RoundLayoutParams elp = (RoundLayoutParams) lp;
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (lp instanceof RoundLayoutParams) {
            RoundLayoutParams elp = (RoundLayoutParams) lp;
            RoundRelativeLayoutParamsData data = elp.getData();
    ...
    static class LayoutParams extends RelativeLayout.LayoutParams implements RoundLayoutParams {

        private RoundRelativeLayoutParamsData data;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            data = new RoundRelativeLayoutParamsData(c, attrs);
        }

        @Override
        public RoundRelativeLayoutParamsData getData() {
            return data;
        }
    }

    public interface RoundLayoutParams {
        RoundRelativeLayoutParamsData getData();
    }
}

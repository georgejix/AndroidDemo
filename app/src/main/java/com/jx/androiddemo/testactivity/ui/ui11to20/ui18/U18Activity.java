package com.jx.androiddemo.testactivity.ui.ui11to20.ui18;
...
import com.jx.androiddemo.testactivity.ui.ui11to20.ui17.ChooseDateView;
...
public class U18Activity extends BaseMvpActivity<EmptyPresenter> implements EmptyContract.View {
    @BindView(R.id.btn_choosedate)
    ...
    private void initChooseDatePop() {
        ...
        if (null != viewHolder && null != viewHolder.chooseDateView && null != calendar) {
            ...
            if (null == viewHolder.chooseDateView.getOnDaySelectedListener()) {
                viewHolder.chooseDateView.setOnDaySelectedListener(index -> {
    ...
    private void showPop() {
        if (null == chooseDatePop) {
            chooseDatePop = LayoutInflater.from(this).inflate(R.layout.pop_choose_date, null);
            ...
            switch (v.getId()) {
                ...
                case R.id.textview_save:
                    ...
                    if (null != viewHolder && null != viewHolder.chooseDateView && null != viewHolder.chooseDateView.getStartTime() &&
                        ...
                        ToastUtil.showTextToast(viewHolder.chooseDateView.getStartTime().toString() + "-" +
                                viewHolder.chooseDateView.getEndTime().toString());
                    }
                    break;
            }
        }
